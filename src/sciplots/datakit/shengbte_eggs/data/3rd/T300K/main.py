...
w_anharmonic = np.loadtxt(
    "/cache/ybgao2024/K3-Rb3-Au3Sb2/result/K3Au3Sb2/sheng80/3rd_scph/T300K/T300K/BTE.w_anharmonic"
)
...
def omega_to_lifetime(omega_min, omega_max):
    return np.linspace(omega_min, omega_max, 1000), 2 * np.pi * 1 / np.linspace(
